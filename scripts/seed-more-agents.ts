...
const AGENTS: AgentConfig[] = [
  {
    ...
    trades: [
      { direction: 0, entry: 88_200000, exit: 90_800000, size: 200_000000, confidence: 8500 },
      { direction: 0, entry: 90_800000, exit: 93_100000, size: 250_000000, confidence: 8100 },
      { direction: 1, entry: 93_100000, exit: 91_200000, size: 180_000000, confidence: 7900 },
      { direction: 0, entry: 91_200000, exit: 94_600000, size: 220_000000, confidence: 8800 },
      { direction: 0, entry: 94_600000, exit: 96_900000, size: 300_000000, confidence: 9100 },
      { direction: 1, entry: 96_900000, exit: 95_300000, size: 150_000000, confidence: 7200 },
      { direction: 0, entry: 95_300000, exit: 97_400000, size: 270_000000, confidence: 8400 },
      { direction: 0, entry: 97_400000, exit: 96_100000, size: 200_000000, confidence: 6800 },
    ],
  },
  {
    name: "momentum-alpha",
    ...
    trades: [
      { direction: 0, entry: 85_000000, exit: 92_500000, size: 1000_000000, confidence: 9200 },
      { direction: 0, entry: 92_500000, exit: 88_100000, size: 900_000000, confidence: 7800 },
      { direction: 1, entry: 88_100000, exit: 91_400000, size: 800_000000, confidence: 6500 },
      { direction: 0, entry: 91_400000, exit: 97_800000, size: 1200_000000, confidence: 8900 },
      { direction: 1, entry: 97_800000, exit: 93_200000, size: 700_000000, confidence: 7100 },
      { direction: 0, entry: 93_200000, exit: 90_500000, size: 1100_000000, confidence: 6200 },
      { direction: 0, entry: 90_500000, exit: 99_300000, size: 950_000000, confidence: 8600 },
      { direction: 1, entry: 99_300000, exit: 96_100000, size: 600_000000, confidence: 5800 },
      { direction: 0, entry: 96_100000, exit: 92_400000, size: 850_000000, confidence: 7400 },
      { direction: 1, entry: 92_400000, exit: 88_900000, size: 750_000000, confidence: 8100 },
      { direction: 0, entry: 88_900000, exit: 94_200000, size: 1000_000000, confidence: 8300 },
      { direction: 0, entry: 94_200000, exit: 90_800000, size: 900_000000, confidence: 6900 },
      { direction: 1, entry: 90_800000, exit: 94_500000, size: 800_000000, confidence: 5500 },
      { direction: 0, entry: 94_500000, exit: 99_100000, size: 1100_000000, confidence: 9000 },
      { direction: 1, entry: 99_100000, exit: 95_600000, size: 650_000000, confidence: 7600 },
    ],
  },
];
